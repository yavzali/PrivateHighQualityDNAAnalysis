...
echo "   1. Convert your 23andMe data: python convert_23andme_binary.py your_data.txt output"
echo "   2. Run analysis: Rscript production_ancestry_system.r input_prefix output_dir/"
echo ""
